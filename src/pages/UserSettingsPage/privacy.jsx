...
const Privacy = () => {
  return (
    <div className="privacy">
      <TopBar title="Privacy Policy" route={'/settings'} />
      <strong>Privacy Policy</strong>{' '}
      <p>
        ACE Uganda built the EPILEPSY SMART app app as a Free app. This SERVICE is provided by ACE
      ...
      <p>
        ...
        which are accessible at EPILEPSY SMART app unless otherwise defined in this Privacy Policy.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        address, phone contact. The information that I request will be retained on your device and
      ...
      <p>
        ...
        on your devices internal memory.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        me at nsubugamike021@gmail.com.
      </p>{' '}
