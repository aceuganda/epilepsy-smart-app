...
const Terms = () => {
  return (
    <div className="terms">
      <TopBar title="Terms and Conditions" route={'/settings'} />
      ...
      <p>
        ACE Uganda is committed to ensuring that the app is as useful and efficient as possible. For
      ...
      <p>
        The EPILEPSY SMART app app stores and processes personal data that you have provided to us,
        ...
        programs, compromise your phone’s security features and it could mean that the EPILEPSY
        SMART app app won’t work properly or at all.
      </p>{' '}
      <div>
      ...
      <p>
        ...
        to keep using the app. ACE Uganda does not promise that it will always update the app so
        that it is relevant to you and/or works with the Android version that you have installed on
        your device. However, you promise to always accept updates to the application when offered
        to you, We may also wish to stop providing the app, and may terminate use of it at any time
