...
const TimeSelector = ({
  onChangeMinutesCallBack,
  onChangeHoursCallBack,
  onChangeZoneCallBack,
  fontSize
}) => {
  ...
  const minutesOverlap = (el1, el2, item) => {
    ...
    if (!(container.top > element.bottom - 5 || container.bottom < element.top + 5)) {
  ...
  return (
    <div className="box">
      <div className="Container">
              ...
              <div
                ...
                className={
                  hoursOverlap(
                    ...
                    document.getElementById(`hours-${index}`),
                    item
                  )
                    ? 'activeTime'
                    : 'inactiveTime'
        ...
        <span className={scrollTop === 0 ? 'startSeparator' : 'Separator'}>:</span>
        <div className="timeUnit">
          <div
            className="scrollDiv"
            onScroll={onScrolling}
            ...
            {[
              ...
              <div
                ...
                className={
                  timeZoneOverlap(
                    document.getElementById('container'),
                    document.getElementById(`ampm-${index}`),
                    item
                  )
                    ? 'activeTimeZone'
                    : 'inactiveTimeZone'
